package com.xionger.qcb.common.util.regex;
...
public class RegexChk {
    ...
    {  
        ...
        checkResult= startCheck(reg,pwd);  
        if(checkResult){
        	if(startCheck("^[a-z]{6,16}$",pwd) || startCheck("^[A-Z]{6,16}$",pwd) ||startCheck("^[0-9]{6,16}$",pwd)||startCheck("^[_]{6,16}$",pwd)){
        		checkResult=false;
        	}
        }
        return checkResult;
     ...
     * @return
     */
    public static boolean isMajuscule(String str){
    ...
    {  
        String reg="^[0-9]{1,2}\\.[0-9]{1,2}\\.[0-9]{1,2}$";  
        boolean checkResult=false;
        checkResult= startCheck(reg,version);  
    ...
    /**
     * @Description:检查是否为有2位的小数
     * @param @param pwd
     * @param @return 
     * @throws
     */
    public static boolean checkDecimal_2(String value)  
    {  
    	String reg="^[0-9]+(\\.)[0-9]{2}$";  
        return startCheck(reg,value);  
    }
    
    /**
     * @Description:检查是否为2016-01-01格式的日期
     * @param @param pwd
     * @param @return 
     * @throws
     */
    public static boolean checkDateYYYY_MM_DD(String value)  
    {  
    	String reg="^[1-9]{1}[0-9]{3}(-)[0-9]{2}(-)[0-9]{2}$";  
        return startCheck(reg,value);  
    }
     ...
     * @throws
     */
    public static boolean checkDateHH_mm_ss(String value)  
    {  
